...
public class Gym {
    ...
    Gym(int totalGymMembers, Map<MachineType, Integer> availableMachines) {
        this.totalGymMembers = totalGymMembers;
        this.availableMachines = availableMachines;
    }

    public void openForTheDay() {
        List<Thread> gymMembersRoutines = IntStream.range(1, this.totalGymMembers)
                .mapToObj(id -> {
    ...
    public static void main(String[] args) {
        Gym globoGym = new Gym(5, new HashMap<MachineType, Integer>() {
            {
