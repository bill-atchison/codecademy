...
public class CakeMaker {
    ...
    public void mixDryIngredients() {
        try {
            ...
            synchronized (this) {
                while(whiskInUse) {
                    printTask("Waiting on the whisk...");
                    wait();
                }
    ...
    public void mixWetIngredients() {
        try {
            ...
            synchronized(this) {
                printTask("Releasing mixing and whisk bowl!");
                whiskInUse = false;
                mixingBowlInUse = false;
                notifyAll();
            }
    ...
    public void combineIngredients() {
        try {
            ...
            synchronized (this) {
                while (mixingBowlInUse) {
                    printTask("Waiting on the mixing bowl...");
                    wait();
                }
            ...
            synchronized (this) {
                printTask("Releasing the mixing bowl and whisk");
                whiskInUse = false;
                mixingBowlInUse = false;
                notifyAll();
            }
        ...
        try {
            ...
            synchronized (this) {
                while(whiskInUse || mixingBowlInUse) {
                    printTask("Waiting on whisk and  mixing bowl");
                    wait();
                }
                printTask("Using the whisk and mixing bowl!");
                whiskInUse = true;
                mixingBowlInUse = true;
            }
            ...
            synchronized (this) {
                printTask("Releasing the whisk and mixing bowl!");
                whiskInUse = false;
                mixingBowlInUse = false;
            }
